    ...
    {/* <section className="relative container mx-auto px-4 lg:px-8 py-16 lg:py-24 overflow-hidden">
     ...
     <section className="container mx-auto px-4 lg:px-8 pb-16 lg:pb-24">
            <div className="relative rounded-lg overflow-hidden h-[250px] md:h-[450px] flex items-center justify-center bg-video-thumbnail">
                ...
                <a href="https://www.youtube.com/watch?v=csqpwWFnoaQ" target="_blank" rel="noopener noreferrer" className="play-button-ripple relative z-10 w-10 h-10 md:w-20 md:h-20 bg-white rounded-full flex items-center justify-center backdrop-blur-sm hover:bg-white/50 transition-colors">
